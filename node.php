    ...
    try {
        ...
        switch ($_GET['operation']) {
            ...
            case 'create_node':
                ...
                $sql      = "INSERT INTO `tree_nodes` (`name`, `text`, `parent_id`) VALUES('".$nodeText."', '".$nodeText."', '".$node."')";
...
**/
          ...
          break;
            ...
            case 'rename_node':
                ...
                //print_R($_GET);
                $nodeText = isset($_GET['text']) && $_GET['text'] !== ''?$_GET['text']:'';
                $sql      = "UPDATE `tree_nodes` SET `name`='".$nodeText."',`text`='".$nodeText."' WHERE `id`= '".$node."'";
                mysqli_query($conn, $sql);
                break;
                ...
                case 'delete_node':
      				$node = isset($_GET['id']) && $_GET['id'] !== '#' ? (int)$_GET['id'] : 0;
      				$sql ="DELETE FROM `tree_nodes` WHERE `id`= '".$node."'";
      				mysqli_query($conn, $sql);
      				break;
      			default:
